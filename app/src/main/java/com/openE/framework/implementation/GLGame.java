...
import com.openE.framework.AccelerometerHandler;
import com.openE.framework.Audio;
import com.openE.framework.FileIO;
import com.openE.framework.Game;
import com.openE.framework.Graphics;
import com.openE.framework.Input;
...
public abstract class GLGame extends Activity implements Game, Renderer {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		input = new AndroidInput(this, glView, 1, 1); // no scaling
	...
	public Graphics getGraphics() {
		throw new IllegalStateException("We r using OPenGL ES !");
	}
